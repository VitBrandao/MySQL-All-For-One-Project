...
This project was my first experience with **MySQL**, when I was starting to learn **Back-End**. 

The challenge was about creating **queries** to search for specific data in a DataBase called Northwind. 
To do so, I had to code and combine MySQL queries by using **MySQL Workbench**.
